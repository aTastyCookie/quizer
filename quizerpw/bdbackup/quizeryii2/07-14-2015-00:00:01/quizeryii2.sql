...
INSERT INTO `node` VALUES (1,'node1',1,0,4,8,420,620);
INSERT INTO `node` VALUES (2,'dasda',1,5,0,9,100,130);
INSERT INTO `node` VALUES (3,'q1',2,0,0,0,0,0);
INSERT INTO `node` VALUES (4,'3node',1,1,8,0,280,480);
INSERT INTO `node` VALUES (5,'как вы относитесь к Путину',1,6,2,4,80,490);
INSERT INTO `node` VALUES (6,'Wehsbsbbs',1,9,5,0,100,700);
INSERT INTO `node` VALUES (7,'q2',2,0,0,0,0,0);
INSERT INTO `node` VALUES (8,'XXXXX',1,4,0,0,410,140);
INSERT INTO `node` VALUES (9,'vasya',1,4,6,0,230,270);
...
-- Dump completed on 2015-07-14  0:00:01
