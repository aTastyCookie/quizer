...
INSERT INTO `node` VALUES (1,'node1',1,0,4,0,380,740);
INSERT INTO `node` VALUES (2,'dasda',1,9,8,0,100,250);
INSERT INTO `node` VALUES (3,'q1',2,0,0,0,0,0);
INSERT INTO `node` VALUES (4,'3node',1,1,9,0,280,480);
INSERT INTO `node` VALUES (5,'как вы относитесь к Путину',1,0,0,0,180,650);
INSERT INTO `node` VALUES (6,'Wehsbsbbs',1,0,0,0,100,700);
INSERT INTO `node` VALUES (7,'q2',2,0,0,0,0,0);
INSERT INTO `node` VALUES (8,'XXXXX',1,2,0,0,110,40);
INSERT INTO `node` VALUES (9,'vasya',1,4,2,0,250,270);
...
-- Dump completed on 2015-07-07  0:00:01
