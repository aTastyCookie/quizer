...
INSERT INTO `node` VALUES (1,'node1',1,0,4,8,420,700);
INSERT INTO `node` VALUES (2,'dasda',1,5,0,9,220,50);
INSERT INTO `node` VALUES (3,'q1',2,0,0,0,0,0);
INSERT INTO `node` VALUES (4,'3node',1,1,9,0,220,540);
INSERT INTO `node` VALUES (5,'как вы относитесь к Путину',1,6,2,0,340,250);
INSERT INTO `node` VALUES (6,'Wehsbsbbs',1,9,5,0,180,260);
INSERT INTO `node` VALUES (7,'q2',2,0,0,0,0,0);
INSERT INTO `node` VALUES (8,'XXXXX',1,0,0,0,370,960);
INSERT INTO `node` VALUES (9,'vasya',1,4,6,0,30,330);
...
-- Dump completed on 2015-07-15  0:00:02
