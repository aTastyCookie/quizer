...
CREATE TABLE `node` (
  ...
  `question` text COLLATE utf8_general_mysql500_ci,
...
INSERT INTO `node` VALUES (1,'node1',1,0,4,8,420,700,NULL,NULL,0);
INSERT INTO `node` VALUES (2,'dasda',1,5,0,9,220,50,NULL,NULL,0);
INSERT INTO `node` VALUES (3,'q1',2,0,0,0,0,0,NULL,NULL,0);
INSERT INTO `node` VALUES (4,'3node',1,1,9,0,220,540,NULL,NULL,0);
INSERT INTO `node` VALUES (5,'как вы относитесь к Путину',1,6,2,0,340,250,NULL,NULL,0);
INSERT INTO `node` VALUES (6,'Wehsbsbbs',1,9,5,0,180,260,NULL,NULL,0);
INSERT INTO `node` VALUES (7,'q2',2,0,0,0,0,0,NULL,NULL,0);
INSERT INTO `node` VALUES (8,'XXXXX',1,0,0,0,370,960,NULL,NULL,0);
INSERT INTO `node` VALUES (9,'vasya',1,4,6,0,30,330,NULL,NULL,0);
...
-- Dump completed on 2015-07-19  0:00:01
